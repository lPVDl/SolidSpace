...
namespace SpaceSimulator.Runtime.Entities.Particles.Rendering
{
    public class TriangleParticleMeshBuilderSystem : SystemBase
    {
        ...
        private TriangleVerticesData _topLeftTriangle;
        private TriangleVerticesData _bottomRightTriangle;
        ...
        protected override void OnCreate()
        {
            ...
            _topLeftTriangle = new TriangleVerticesData
            {
                point0 = new float2(-0.5f, -0.5f),
                point1 = new float2(-0.5f, 0.5f),
                point2 = new float2(0.5f, 0.5f)
            };
            _bottomRightTriangle = new TriangleVerticesData
            {
                point0 = new float2(-0.5f, -0.5f),
                point1 = new float2(0.5f, 0.5f),
                point2 = new float2(0.5f, -0.5f),
        ...
        protected override void OnUpdate()
        {
            ...
            var computeMeshJob = new ComputeTriangleParticleMeshJob
            {
                ...
                vertices = Vertices,
                triangle = (_frameIndex % 2 == 0) ? _topLeftTriangle : _bottomRightTriangle
            };
