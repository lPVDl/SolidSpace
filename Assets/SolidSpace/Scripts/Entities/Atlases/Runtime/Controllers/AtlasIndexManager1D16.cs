...
{
    public class AtlasIndexManager1D16 : IDisposable
    {
        ...
        public AtlasIndexManager1D16(Atlas1DConfig config)
        {
        ...
        public AtlasIndex16 Allocate(int size)
        {
        ...
        public void Release(AtlasIndex16 index)
        {
            ...
            {
                throw new InvalidOperationException($"Can not release index {index}. It is not allocated.");
            }
