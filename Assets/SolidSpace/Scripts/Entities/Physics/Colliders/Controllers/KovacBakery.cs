...
namespace SolidSpace.Entities.Physics.Colliders
{
        ...
        where T : struct, IColliderWorld
    {
        ...
        public KovacWorld<T> Bake()
        {
            ...
            var worldGrid = ColliderBakeSystem.GridUtil.Static_ComputeGrid(dataCollectJob.outBounds, colliderCount, Profiler);
            ...
            new WorldChunkListsCapacityJob
            {
            ...
            var listsFillJob = new WorldChunkListsFillJob
            {
                inColliderBatchCapacity = 128 * 4,
                inColliders = bakingJob.outColliders,
                inColliderCounts = bakingJob.outColliderCounts,
